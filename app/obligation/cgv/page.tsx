...
export default async function CGV() {
  ...
  return (
    ...
    <article className="text-sm font-sans flex flex-col text-center justify-center items-center tracking-widest mt-20 mb-20 px-10">
        ...
        <p className="mt-10">
            1. Objet <br />
            Ces conditions générales de vente régissent l&ldquo;utilisation de la plateforme développée par Lenny GOMES PINTO BARRETO, permettant aux utilisateurs de générer une checklist intelligente et personnalisée pour leur mariage, via un assistant IA. <br /> <br />

            2. Accès et inscription <br />
            L&ldquo;accès à la plateforme nécessite la création d&ldquo;un compte par l&ldquo;utilisateur (email et prénom). <br /> <br />
            ...
            4. Paiement <br />
            Les paiements sont réalisés via Stripe, en une fois. Aucun abonnement n&ldquo;est requis. <br /> <br />

            5. Livraison <br />
            L&ldquo;accès au service est immédiat après paiement. <br /> <br />

            6. Remboursement <br />
            Aucun remboursement n&ldquo;est possible après l&ldquo;achat. <br /> <br />
