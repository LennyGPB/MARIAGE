...
export default function LandingMain({user} : Props) {
    return (
        ...
        <article id="landing" className="z-50 font-sans flex flex-col justify-center items-center tracking-wide mt-7 md:mt-20">
            ...
            <Link href={user?.hasChecklist ? "/dashboard" : "/quiz"}><ShimmerButton background="#DB80FF" borderRadius="20px" shimmerColor="white" className="text-xs w-[370px] md:text-md md:w-[550px] text-white tracking-widest uppercase hover:scale-105 transition duration-300 ease-in-out"><span className="font-bold text-xl">Commencer gratuitement</span></ShimmerButton></Link>
            <Link href="/#faq"><ShimmerButton background="white" borderRadius="20px" shimmerColor="white" className="px-2 w-[370px] md:w-[550px] text-black/70 tracking-widest border border-black/30 hover:scale-105 transition duration-300 ease-in-out"><span className="text-md">F.A.Q</span></ShimmerButton></Link>
            </div>
