        ...
        <>
            <footer className="w-full bottom-0 left-0 font-sans mt-10">
                <div className="flex flex-col md:flex-row justify-center items-center gap-1 text-center ">
                    <p className="text-[10px] text-gray-600">© {new Date().getFullYear()} EasyWed. Tous droits réservés.</p>
                    <p className="text-[10px] text-gray-500">Made with ❤️ by InTheGleam</p>
                </div>

                <div className="text-[8px] md:text-[10px] flex flex-wrap gap-2 justify-center items-center mt-2 sm:mt-1 mb-4 sm:mb-2">
