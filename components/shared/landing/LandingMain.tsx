...
export default function LandingMain({user} : Props) {
    return (
        ...
        <article id="landing" className="z-50 font-sans flex flex-col justify-center items-center tracking-wide md:mt-20">
            <SparklesText className="hidden md:block md:[800px] lg:w-[1000px] text-center text-5xl font-light leading-[67px] md:mt-16 mt-10 tracking-wide">Organisez <span className="text-[#DB80FF] font-bold">votre mariage</span> sans stress, avec une checklist intelligente.</SparklesText>
            ...
            <p className="text-black/50 text-md md:text-lg text-center w-[350px] md:w-[700px] lg:w-[795px] mt-5 font-light">Créez un plan clair, personnalisé et évolutif selon votre date, votre style, et vos envies. Enfin un outil qui <span className="font-medium">pense comme vous</span>.</p>
